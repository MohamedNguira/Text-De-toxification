...
data  = datasets.load_from_disk(os.path.join(DATA_FOLDER, f'toxicity_data')) 

import src.data_preparation.prepare_data as pdr
train_data, val_data, test_data = pdr.data_split(all_data=data, train_portion=0.9, val_portion=0.05)
...
training_args = TrainingArguments(os.path.join(os.getcwd(), "final_toxic_classifier"), 
